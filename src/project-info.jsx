  ...
  return (
    <Box>
      ...
      <Box sx={{ margin: "8px 8px 16px", justifyContent: "center", display: "flex", padding: 2, border: "solid 2px yellow", borderRadius: 5, "> a": { textDecorationColor: "#66A3F0" }, ">:first-of-type": { marginRight: 4 } }}>
        <Typography color="white" component="div">
          ...
          <ul>
            ...
            <li><a href="https://docs.google.com/document/d/1ZnjSX_bIyDE27oLJK7YGRDAKirETrw7V7W_5zVqCaFg" target="_blank" rel="noreferrer"><Typography color="#66A3F0" sx={{ height: 50 }}>DEVELOPER DOCUMENTATION</Typography></a></li>
            <li><a href="https://github.gatech.edu/dstrube3/CS6150-DUCSS" target="_blank" rel="noreferrer"><Typography color="#66A3F0" sx={{ height: 50 }}>GITHUB FOR ANDROID APP</Typography></a></li>
          </ul>
        </Typography>
      </Box>
      ...
      <Typography component="div" color="white">
          This week (4/21 thru 4/28) our team is working towards:
          <ul>
            <li>Preparing the final report</li>
            <li>Tidying up loose ends in app</li>
            <li>Analyzing some user feedback we received from our project stakeholders</li>
            <li>Coordinate one final meeting with staholders and prepare project hand-off</li>
          </ul>
        </Typography>
      </Box>
